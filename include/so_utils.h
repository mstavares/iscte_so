 ...
 */
#define so_success(passo, fmt, ...) do { *passo ? fprintf(stderr, COLOUR_BACK_GREEN "@SUCCESS {" passo "}" COLOUR_GREEN " [" fmt "]" COLOUR_NONE "\n", ## __VA_ARGS__) : fprintf(stderr, COLOUR_BACK_GREEN "@SUCCESS" COLOUR_GREEN " [" fmt "]" COLOUR_NONE "\n", ## __VA_ARGS__); } while (0)
 ...
 * @param 3..n: Informações adicionais que sejam pedidas no passo avaliado
 */
#define so_error(passo, fmt, ...) do { *passo ? fprintf(stderr, COLOUR_BACK_BOLD_RED "@ERROR {" passo "}" COLOUR_RED " [" fmt "]" COLOUR_NONE "\n", ## __VA_ARGS__) : fprintf(stderr, COLOUR_BACK_BOLD_RED "@ERROR" COLOUR_RED " [" fmt "]" COLOUR_NONE "\n", ## __VA_ARGS__); if (errno) perror(""); } while (0)
